...
const
    InfoModal: React.FC<InfoModalProps> = ({visible, onClose}) => {
            ...
            ">
                    <div
                        ...
                        <div className="relative h-95">
                            ...
                            <div
                                className="cursor-pointer absolute top-3 right-3 h-10 w-10 rounded-full bg-opacity-70 bg-black flex items-center justify-center"
                                onClick={handleClose}>
